                ...
                {results.summary && (
                  <>
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{results.summary.total_rows}</p>
                    </div>
                    <div>
                      <span className="text-gray-600">Completed Fields:</span>
                      <p className="font-semibold text-green-600">{results.summary.completed_fields}</p>
                    </div>
                    <div>
                      <span className="text-gray-600">Missing Fields:</span>
                      <p className="font-semibold text-orange-600">{results.summary.missing_fields}</p>
                    </div>
                  </>
                )}
              </div>
